...
namespace PDF_Manager.Printing
{
    class InputDiagramLoad
    {
        ...
        */
        ...
        internal void DiagramOfLoadPDF(PdfDoc mc, InputNode cls_node, InputMember cls_member, InputElement cls_element, InputFixNode cls_fixnode, InputJoint cls_joint, InputFixMember cls_fixmember, InputLoadName cls_loadname, InputLoad cls_load)
        {
