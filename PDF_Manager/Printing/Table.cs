...
namespace PDF_Manager.Printing
{
    public class Table
    {
        ...
        public void setRowCount(int _rows, int _cols)
        {
            // 昔の情報を取っておく
            var oldCell   = new string[_rows, _cols];
            var oldAlignX = new string[_rows, _cols];
            var oldAlignY = new string[_rows, _cols];
            ...
            int oldCols = this.CellCols; // 昔のデータの列数
